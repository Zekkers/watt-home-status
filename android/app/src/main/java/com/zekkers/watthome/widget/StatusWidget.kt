...
private fun StatusWidgetContent(status: HomeStatus?) {
    ...
    Column(
        ...
        Spacer(GlanceModifier.height(2.dp))
        Text(
            text = "Power Up ${StatusFormatter.nextPowerUp(status?.nextPowerUp)}",
            style = TextStyle(color = ColorProvider(Cream, Cream), fontSize = 12.sp)
        )
        Spacer(GlanceModifier.height(8.dp))
        Text(
...
private val Leaf = Color(0xFFC8E6C9)
private val Mint = Color(0xFFA5D6A7)
private val Cream = Color(0xFFE8F5E9)
private val Solar = Color(0xFFF9A825)
private val SolarSoft = Color(0xFFFFE082)
